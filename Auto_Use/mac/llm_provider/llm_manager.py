...
- Examples:
  ...
  3. Project file via absolute path:
     view {"path": "/Users/you/projects/app/src/main.py", "start": 0, "end": 0}
  4. Pair pattern — grep first, then view a narrow range:
     ...
     Step 2: view {"path": "Auto_Use/mac/agent/cli/service.py", "start": 220, "end": 260}"""),
...
- Examples:
  ...
  3. Two facts confirmed in one step — two separate calls:
     scratchpad {"value": "**Verified:** parser handles empty input — **6/6** cases pass"}, scratchpad {"value": "**Saved:** report exported to `/Users/me/Desktop/q3_report.pdf`"}"""),
...
- Good examples (state what you want, not how to get it):
  ...
  2. minion {"value": "list all imports of ScratchpadService under Auto_Use/mac/ with line numbers + direct usages."}
  3. minion {"value": "give me a list of all files and directories under /Users/me/Downloads with a one-line summary of each."}
...
- Allowed examples:
  ...
  3. shell {"command": "wc -l Auto_Use/mac/agent/service.py", "input": ""}
...
- Format: scratchpad {"value": "<one-line verified note in markdown format>"}
- Examples:
  1. scratchpad {"value": "`Auto_Use/mac/agent/service.py:254` — `_read_scratchpad_from_file` definition"}
  2. scratchpad {"value": "`Auto_Use/mac/controller/view.py:620` — `action_type == \"scratchpad\"` routing branch"}
...
def _main_tools(track: dict) -> list:
    ...
    return [
        ...
        _tool("input", {"id": {"type": "integer"}, "value": {"type": "string"}},
              ...
              '    3. Example: input {"id": 9, "value": "hi, how are you"}', track=track),
        _tool("typewrite", {"value": {"type": "string"}},
              ...
              '    2. Example: typewrite {"value": "hi, how are you"}', track=track),
        ...
        _tool("hotkey", {"value": {"type": "string"}},
              ...
              '        2. hotkey {"value": "cmd+shift+s"}', track=track),
        ...
        _tool("drag_drop", {"value": {"type": "string"}},
              ...
              '    1. Format: drag_drop {"value": "<from_id> to <to_id>"}\n'
              '    2. Example: drag_drop {"value": "8 to 15"}', track=track),
