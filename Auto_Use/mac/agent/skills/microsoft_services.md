...
1. Excel Online:
   ...
   - Table entry (row-by-row, horizontal):
     ...
     - To enter a row:
      ...
      - Example Format: `input {"id": <name_box_id>, "value": "A1"},hotkey {"value": "enter"},typewrite {"value": "<col1>"},hotkey {"value": "tab"},typewrite {"value": "<col2>"},hotkey {"value": "tab"}`
...
3. Outlook (outlook.live.com / outlook.office.com):
   - Single recipient:
     ...
     - Format: `input {"id": <to_element>, "value": "<email>"},input {"id": <subject_element>, "value": "<subject>"},left_click {"id": <body_element>, "clicks": 1},typewrite {"value": "<body_text>"}`
   - Multiple recipients:
