...
3. Always anchor findings to `path:line_no` (e.g. `Auto_Use/mac/agent/service.py:423`). Vague references like "somewhere in service.py" are never acceptable.
...
Examples:
- "memory: S3 ok. grep found _read_scratchpad at service.py:254 (definition confirmed). Expect: view 240-270 shows the function body + return. next_goal: This step: view service.py 240-270 to confirm the function. Next: grep for callers."
