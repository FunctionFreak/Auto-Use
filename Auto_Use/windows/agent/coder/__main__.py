...
Usage:
    python -m Auto_Use.windows.agent.coder --task "your task here"
...
When called directly for testing:
    - Run: python -m Auto_Use.windows.agent.coder --task "test task"
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
    python -m Auto_Use.windows.agent.coder --task "fix the bug in test.py"
    python -m Auto_Use.windows.agent.coder --task "create hello world" --provider openrouter --model gemini-3.6-flash
        """
    )
