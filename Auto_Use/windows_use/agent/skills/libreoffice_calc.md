...
1. Visual Focus and Navigation
    ...
    1.4 Eg: [{ "type": "input", "id": 24, "text": "A1" }, { "type": "hotkey", "value": "enter" }, { "type": "typewrite", "text": "name" }, { "type": "hotkey", "value": "tab" }]
...
3. Using OCR_TEXT for Editing
    ...
    3.2. You can edit a cell by identifying its element ID, performing a triple-click, and then using typewrite. This will override the existing text.
...
4. Overriding an Entire Row
    ...
    4.2. Use the shortcut 'Ctrl + End' to automatically select the whole row pared with typewrite + tab to insert the new values and override the selected row .
5. Avoid Unnecessary Clicks
    ...
    5.2. Stick to using `typewrite` and the 'Tab' key when you are already on the desired cell.
