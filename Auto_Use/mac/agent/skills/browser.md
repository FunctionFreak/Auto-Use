...
<navigation_rules>
1. Prefer input + clicks + AppleScript for faster execution.
2. While collecting memory, drill down through the site toward your goal.
3. Never type unknown URLs directly — reach them via redirects or clicks.
</navigation_rules>
<download_rules>
...
7. When done: dump everything into TextEdit with start/finish timestamps, save to Desktop with a fitting name.
</web_scraping_rules>
